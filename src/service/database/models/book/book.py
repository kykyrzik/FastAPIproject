from sqlalchemy import Column, VARCHAR, Integer, ForeignKey, Date, DECIMAL, BLOB
...
class Books(Base):
    ...
    rars = relationship("RARS", back_populates="books")
    cover_type = relationship("CoverType", back_populates="books")
